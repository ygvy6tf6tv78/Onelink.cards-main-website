...
const slides: Array<{
  ...
  {
    id: "veloura-salon",
    src: velouraSalonMockup,
    alt: "Veloura Salon OneLink mobile mockup",
    label: "Veloura Salon",
    description: "Services, appointments, payments, contact.",
  },
  {
    id: "vastukar",
    src: vastukarMockup,
    alt: "Vastukar Architects OneLink mobile mockup",
    label: "Vastukar Architects",
    description: "Portfolio, services, bookings, location.",
  },
  {
    id: "new-vision",
    src: newVisionMockup,
    alt: "New Vision Diagnostics OneLink mobile mockup",
    label: "New Vision Diagnostics",
      ...
      <div className="relative flex flex-col items-stretch">
        <div className="relative flex min-h-[420px] justify-center pt-4 pb-1 sm:min-h-[520px] sm:items-center sm:pt-6 sm:pb-2 lg:min-h-[430px] lg:pt-7 lg:pb-2">
          <motion.div
            ...
            className="absolute left-2 top-[88px] z-0 hidden w-[142px] opacity-[0.18] blur-[1px] xl:block"
            aria-hidden="true"
          >
          ...
          <motion.div
            ...
            className="absolute right-4 top-[68px] z-0 hidden w-[154px] opacity-[0.2] blur-[1px] lg:block"
            aria-hidden="true"
          >
