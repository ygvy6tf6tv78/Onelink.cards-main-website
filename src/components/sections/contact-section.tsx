  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <Reveal x={-22} y={16}>
          <div className="relative overflow-hidden rounded-[30px] border border-white/12 bg-[linear-gradient(135deg,#03182e_0%,#006eb2_55%,#00A9FF_100%)] px-6 py-8 shadow-[0_34px_84px_-46px_rgba(0,113,188,0.64)] sm:px-10 sm:py-9 lg:px-14 lg:py-10">
            ...
            <div className="relative grid gap-7 text-center lg:grid-cols-[1fr_auto] lg:items-end lg:gap-12 lg:text-left">
              ...
              <div className="flex flex-col justify-center gap-3 sm:flex-row lg:flex-col lg:justify-end">
