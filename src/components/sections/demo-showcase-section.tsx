        ...
        <Reveal x={-28} y={14}>
          <div className="text-center">
            <div className="mx-auto max-w-7xl">
              ...
              <h2 className="section-title-gradient font-display mx-auto mt-4 max-w-none text-[clamp(1.18rem,6vw,1.6rem)] font-bold leading-[1.12] tracking-[-0.045em] sm:text-[36px] sm:leading-[1.08] lg:text-[42px]">
