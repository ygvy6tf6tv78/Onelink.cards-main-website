...
export const pricingPlans: Plan[] = [
  {
    ...
    maintenanceOptions: [
      { id: "3-month", label: "3 Months", price: 2000 },
      { id: "6-month", label: "6 Months", price: 3500 },
      { id: "12-month", label: "12 Months", price: 6000 },
    ],
    taxText: "GST Extra",
    orderMode: "full",
    hsnSac: "9983",
  ...
  },
  {
    ...
    maintenanceOptions: [
      { id: "3-month", label: "3 Months", price: 3000 },
      { id: "6-month", label: "6 Months", price: 5000 },
      { id: "12-month", label: "12 Months", price: 9000 },
    ],
    taxText: "GST Extra",
    tone: "premium",
    orderMode: "full",
  ...
  },
  {
    ...
    maintenanceOptions: [
      { id: "3-month", label: "3 Months", price: 4500 },
      { id: "6-month", label: "6 Months", price: 8000 },
      { id: "12-month", label: "12 Months", price: 14000 },
    ],
    taxText: "GST Extra",
    tone: "premium",
    orderMode: "full",
