...
export const pricingPlans: Plan[] = [
  {
    ...
    maintenanceOptions: [
      { id: "3-month", label: "3 Months", price: 1599 },
      { id: "6-month", label: "6 Months", price: 2799 },
      { id: "12-month", label: "12 Months", price: 4999 },
    ],
    taxText: "+ GST (18%)",
    orderMode: "full",
    hsnSac: "9983",
  ...
  },
  {
    ...
    maintenanceOptions: [
      { id: "3-month", label: "3 Months", price: 2799 },
      { id: "6-month", label: "6 Months", price: 4999 },
      { id: "12-month", label: "12 Months", price: 8999 },
    ],
    taxText: "+ GST (18%)",
    tone: "premium",
    orderMode: "full",
  ...
  },
  {
    ...
    maintenanceOptions: [
      { id: "3-month", label: "3 Months", price: 4499 },
      { id: "6-month", label: "6 Months", price: 8499 },
      { id: "12-month", label: "12 Months", price: 14999 },
    ],
    taxText: "+ GST (18%)",
    tone: "premium",
    orderMode: "full",
